export const SITE_NAME = 'ToolLu'
export const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.toollu.cn'
export const DEFAULT_TITLE = 'ToolLu - AI 工具发现与推荐平台'
export const DEFAULT_DESCRIPTION =
  'ToolLu 是面向任务的 AI 工具发现与推荐平台，帮助你更快找到能解决问题的那一个。'

export const PAGES = {
  tools: {
    title: 'AI 工具库 - ToolLu | 探索最新最全的 AI 工具',
  ...
  toolsNew: {
    title: '最新上线 - ToolLu',
    description: '刚刚收录进 ToolLu 的新工具，适合第一时间试用和跟踪。',
    path: '/tools/new',
    heading: '最新上线',
    lead: '刚刚收录进 ToolLu 的新工具，适合第一时间试用和跟踪。',
  },
  toolsTrending: {
    title: '热门工具 - ToolLu',
  ...
  categories: {
    title: 'AI 工具分类导航 | 功能、行业与技术维度 - ToolLu',
  ...
  about: {
    title: '关于 ToolLu - AI 工具发现、评测与选型平台',
    description: '了解 ToolLu 如何按任务、分类、榜单和 AI观察组织 AI 工具，帮助你更快判断哪一个适合自己的工作流。',
    path: '/about',
  },
  contact: {
    title: '联系我们 | ToolLu 官方联系页面',
    description: '有问题、合作或建议？欢迎通过 2201219073@qq.com 或微信号 S_7512 联系。',
    path: '/contact',
  },
  submit: {
    title: '提交 AI 工具 - ToolLu',
    description: '提交你的 AI 工具，进入 ToolLu 分类、搜索和详情页，触达正在寻找解决方案的用户。',
    path: '/submit',
  },
  faq: {
    title: '常见问题 - ToolLu AI 工具发现与选型指南',
    description: '了解如何发现 AI 工具、理解榜单和 AI观察、提交工具，以及在选型时需要注意什么。',
    path: '/faq',
  },
  terms: {
    title: '服务条款 | ToolLu AI工具平台',
    description: '使用 ToolLu 前请阅读服务条款，了解使用规则、内容责任与第三方链接说明。',
    path: '/terms',
  },
  privacy: {
    title: '隐私政策 | ToolLu',
    description: '了解 ToolLu 如何收集、使用、存储和保护你的个人信息。',
    path: '/privacy',
  },
  profile: {
    title: '我的 - ToolLu',
  ...
  tasks: {
    title: '浏览 AI 任务 - ToolLu',
    description: '从你想完成的事情出发，而不是从工具名字出发。每个任务都会连到对应分类和代表工具。',
    path: '/tasks',
  },
  search: {
    title: '搜索 - ToolLu',
    description: '搜索 ToolLu 收录的 AI 工具、分类和观察内容。',
    path: '/search',
    noIndex: true,
  },
}
...
export function searchMeta(q = '') {
  return pageMeta({
    title: q ? `搜索：${q} - ToolLu` : PAGES.search.title,
