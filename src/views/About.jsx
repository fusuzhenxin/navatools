...
export default function About() {
  return (
    <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6">
      <p className="text-sm font-medium text-brand">About ToolLu</p>
      <h1 className="mt-3 text-4xl font-bold leading-tight">让 AI 工具选择变得更清楚</h1>
      <p className="mt-4 text-lg leading-8 text-text-secondary">
        ToolLu 关注一个具体问题：当新的 AI 应用不断出现时，中文用户怎样更快判断哪一个真正适合自己的工作流。我们把工具、任务、分类、榜单和内容连接起来，减少反复搜索和盲目试错。
      </p>
      ...
      <p className="mt-3 leading-7 text-text-secondary">
        ToolLu 不是简单的链接集合。我们希望用更贴近日常工作的方式组织 AI 工具：你可以从工具名称进入，也可以从“我想完成什么任务”开始；可以看最新收录，也可以通过免费、精选、趋势和专题内容找到更稳妥的起点。
      </p>
      ...
      <p className="mt-3 text-text-secondary">如果你正在为个人创作、团队效率、产品研发或业务增长寻找 AI 工具，ToolLu 可以作为日常选型和持续跟进的入口。</p>
