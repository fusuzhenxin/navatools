...
export default function Privacy() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
      ...
      <p className="mt-4 leading-7 text-text-secondary">欢迎使用 ToolLu。我们高度重视您的隐私与数据安全。本隐私政策详细说明了我们如何收集、使用、存储和保护您的个人信息。</p>
      <h2 className="mt-10 text-2xl font-bold">信息收集</h2>
      <p className="mt-3 leading-7 text-text-secondary">我们可能收集您在使用 ToolLu 服务时主动提供的信息，如注册信息、联系方式等；以及使用过程中产生的使用数据、设备信息和日志数据。</p>
      ...
      <p className="mt-3 leading-7 text-text-secondary">除法律法规要求或征得您授权同意外，ToolLu 不会将您的个人信息出售、出租或泄露给任何第三方。</p>
