...
const GROUPS = [
  {
    ...
    items: [
      ['ToolLu 是什么？', 'ToolLu 是面向中文用户的 AI 工具发现与选型平台。我们按工具、任务、类别、榜单和 AI观察组织信息，帮助创作者、开发者、产品团队、运营和知识工作者更快找到适合自己工作流的 AI 应用。'],
      ['ToolLu 和普通 AI 工具导航有什么不同？', '我们不只做链接收录，更强调可比较、可判断和可继续探索。你可以从具体任务进入，也可以通过免费工具、精选工具、趋势榜单和 AI观察了解产品变化、使用场景和选型思路。'],
      ['ToolLu 未来重点会放在哪里？', '未来重点会放在更高质量的 AI 工具库、面向任务的选型入口、榜单体系，以及 /insights 下的 AI观察内容。'],
    ],
  },
  {
    title: '工具发现与选型',
    ...
    items: [
      ...
      ['ToolLu 会给出唯一的最佳工具答案吗？', '通常不会。AI 工具选型和预算、语言、团队流程、数据安全要求都有关。我们更倾向于帮你缩小范围、理解差异。'],
    ],
  },
  {
    title: 'AI观察与内容',
    ...
    items: [
      ['AI观察是什么？', 'AI观察是 ToolLu 用来跟踪 AI 工具趋势、产品发布、工作流变化和选型判断的内容模块。'],
      ['为什么不再重点更新早期文章模块？', '早期 /posts 模块已经不适合当前产品重点。后续新内容会更集中地放在 /insights。'],
    ],
  },
  {
    title: '提交、更新与合作',
    desc: '如何提交工具、反馈错误信息或联系 ToolLu。',
    items: [
      ['如何向 ToolLu 提交新的 AI 工具？', '你可以通过提交工具页面提供工具名称、官网链接、简介、分类建议和补充信息。'],
      ['提交工具后一定会被收录吗？', '不一定。我们会优先考虑可访问性、实际用途、信息完整度、用户价值和重复度。'],
      ['ToolLu 接受品牌合作或内容合作吗？', '可以交流，但合作内容需要保持清晰标识和基本客观性。'],
    ],
  },
  {
    title: '账号、收藏与隐私',
    ...
    items: [
      ['必须注册账号才能使用 ToolLu 吗？', '不需要。大部分工具浏览、分类、榜单和 AI观察内容都可以直接访问。'],
...
export default function FAQ() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
      <p className="text-sm font-medium text-brand">ToolLu FAQ</p>
      <h1 className="mt-2 text-4xl font-bold">常见问题</h1>
      <p className="mt-4 text-text-secondary">这里整理了 ToolLu 当前最重要的使用问题：如何发现 AI 工具、如何理解榜单和 AI观察、怎样提交工具，以及在选型时需要注意什么。</p>
